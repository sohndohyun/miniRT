...
/*   Updated: 2020/12/19 20:48:56 by dsohn            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector3		vector3_refract(
	t_vector3 uv, t_vector3 n, double etai_over_etat)
{
	double		cos_theta;
	t_vector3	out_perp;
	...
	out_perp = vector3_mult(vector3_add(uv,
		vector3_mult(n, cos_theta)), etai_over_etat);
	out_parallel = vector3_mult(n,
		-sqrt(fabs(1.0 - vector3_length_squared(out_perp))));
